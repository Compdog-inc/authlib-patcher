...
class YggdrasilPatcher : Patcher {
    ...
    override fun canPatchEntry(entryName: String): Boolean {
        return entryName == "com/mojang/authlib/yggdrasil/YggdrasilAuthenticationService.class" ||
                entryName == "com/mojang/authlib/yggdrasil/YggdrasilMinecraftSessionService.class"
    }
